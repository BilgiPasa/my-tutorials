...
MonoBehaviour:
  ...
  m_MinSize: {x: 0, y: 0}
  m_MaxSize: {x: 0, y: 0}
  m_LastLoadedLayoutName: myUnityLayout
--- !u!114 &9
MonoBehaviour:
  m_ObjectHideFlags: 52
  m_CorrespondingSourceObject: {fileID: 0}
...
MonoBehaviour:
  ...
  m_LastFolders:
  - Assets
  m_LastFoldersGridSize: 82
  m_LastProjectPath: /media/bilgipasa/Data/BILGI_PASA Projects/Unity/3D First Person
    Movement 2
  m_LockTracker:
    m_IsLocked: 0
  m_FolderTreeState:
    scrollPos: {x: 0, y: 25}
    m_SelectedIDs: 72ab0000
    m_LastClickedID: 43890
    m_ExpandedIDs: 0000000072ab000000ca9a3bffffff7f
    m_RenameOverlay:
...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 0
      ...
      index: 1
      contents: '{"m_Layout":1,"m_Collapsed":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-141.0,"y":-70.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -141, y: -70}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 1
      size: {x: 0, y: 0}
    ...
    - dockPosition: 1
      ...
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":true,"m_Floating":false,"m_FloatingSnapOffset":{"x":-47.0,"y":-43.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 1
      snapOffset: {x: -47, y: -43}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 0, y: 0}
  ...
  m_Position:
    m_Target: {x: 2.0570042, y: 4.8164554, z: 26.802908}
    speed: 2
    m_Value: {x: 2.0570042, y: 4.8164554, z: 26.802908}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
  ...
  m_Grid:
    ...
    m_gridOpacity: 0.5
  m_Rotation:
    m_Target: {x: 0.1208195, y: -0.82366073, z: 0.19138646, w: 0.5199648}
    speed: 2
    m_Value: {x: -0.120819114, y: 0.8236581, z: -0.19138585, w: -0.51996315}
  m_Size:
    m_Target: 10.92025
    speed: 2
    m_Value: 10.92025
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_DrawArea:
      ...
      width: 1201
      height: 688
    m_Scale: {x: 0.6255208, y: 0.6255208}
    m_Translation: {x: 600.5, y: 344}
    m_MarginLeft: 0
    m_MarginRight: 0
    m_MarginTop: 0
    m_MarginBottom: 0
    m_LastShownAreaInsideMargins:
      ...
      height: 1099.8834
    m_MinimalGUI: 1
  m_defaultScale: 0.6255208
  m_LastWindowPixelSize: {x: 1201, y: 709}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
